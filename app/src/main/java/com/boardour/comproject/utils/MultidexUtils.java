package com.boardour.comproject.utils;
...
public class MultidexUtils {
    ...
    public static boolean isVMMultidexCapable(String versionString) {
        ...
        Log.e("MultiDex", "VM with version " + versionString + (isMultidexCapable ? " has multidex support" : " does not have multidex support"));
   ...
   /* public static void loadMultiDex(Context context) {
        ...
        Log.e(TAG, "第二次 MultiDex.install 结束，耗时: " + (System.currentTimeMillis() - startTime));
    }*/
    ...
    public static void checkUntilLoadDexSuccess(Context context) {
        ...
        try {
            ...
            while (file.exists()) {
                ...
                if (i > 400) {
                    Log.e(TAG, "checkUntilLoadDexSuccess: 超时，等待时间： " + (waitTime * i));
                    break;
                }
            }
            Log.e(TAG, "checkUntilLoadDexSuccess: 轮循结束，等待时间 " +(waitTime * i));
